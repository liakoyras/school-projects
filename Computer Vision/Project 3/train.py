...
It creates vocabularies with different word counts, encodes
the given training set using these vocabularies and trains
...
create_vocabulary(400, 'imagedb_train/', train_folders, sift, True)
create_vocabulary(500, 'imagedb_train/', train_folders, sift, True)
...
epsilon = [1.e-08, 1.e-06, 1.e-04, 1.e-02, 1.e-01]
